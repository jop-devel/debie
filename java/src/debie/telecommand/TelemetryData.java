...
public class TelemetryData implements TelemetryObject {
	...
	/* dpu_time_t */    Dpu.Time    TC_time_tag;                       /* reg   4 -   7 */
...
//	/* unsigned char */ byte        not_used_1;                        /* reg  30       */
	...
	/* tm_dpu_time_t */ Dpu.Time    time;                              /* reg 106 - 109 */
...
//	/* unsigned char */ byte        not_used;                          /* reg 117       */
	...
	public int getByte(int index) {
		...
		case 4: case 5: case 6: case 7:
			return TC_time_tag.getByte(index-4);
		...
		case 62:
			return os_attach_interrupt_error & 0xff;
		...
		case 78:
			return os_enable_isr_error & 0xff;
		...
		case 94:
			return failed_code_address & 0xff;
		case 95:
			return (failed_code_address >> 8) & 0xff;
		case 96: 
			return failed_data_address & 0xff;
		case 97: 
			return (failed_data_address >> 8) & 0xff;
