...
import static debie.target.SensorUnit.*;

public class SensorUnitSettings {
	/* unsigned char */ int plus_5_voltage;                    /* word  1 */
	/* unsigned char */ int minus_5_voltage;                   /* word  2 */
	/* unsigned char */ int plasma_1_plus_threshold;           /* word  3 */
	/* unsigned char */ int plasma_1_minus_threshold;          /* word  4 */
	/* unsigned char */ int piezo_threshold;                   /* word  5 */
	/* unsigned char */ int plasma_1_plus_classification;      /* word  6 */
	/* unsigned char */ int plasma_1_minus_classification;     /* word  7 */
	/* unsigned char */ int piezo_1_classification;            /* word  8 */
	/* unsigned char */ int piezo_2_classification;            /* word  9 */
	/* unsigned char */ int plasma_2_plus_classification;      /* word 10 */
	/* unsigned char */ int plasma_1_plus_to_minus_max_time;   /* word 11 */
	/* unsigned char */ int plasma_1_plus_to_piezo_min_time;   /* word 12 */
	/* unsigned char */ int plasma_1_plus_to_piezo_max_time;   /* word 13 */
	/* unsigned char */ int plasma_1_minus_to_piezo_min_time;  /* word 14 */
	/* unsigned char */ int plasma_1_minus_to_piezo_max_time;  /* word 15 */
